...
import superfast.games.{CoinGame, CoinGameGenerator, KitchenGame, KitchenGameGenerator, TWCGame, TWCGameGenerator}
import superfast.generator.GameGenerator
import superfast.goldagent.KitchenGoldAgent
import superfast.objects.{Counter, FastObject, Fridge, Room}
import superfast.struct.TextGame
