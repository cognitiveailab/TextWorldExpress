...
import superfast.goldagent.KitchenGoldAgent
import superfast.objects.{Backyard, Bathroom, Bedroom, Cookbook, Corridor, Counter, DoorMaker, Driveway, FastObject, Kitchen, Knife, LaundryRoom, LivingRoom, Meal, Pantry, Room, Street, Supermarket}
